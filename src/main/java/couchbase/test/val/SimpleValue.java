...
import couchbase.test.docgen.DocType.Attributes;
import couchbase.test.docgen.DocType.Details;
import couchbase.test.docgen.DocType.Dimensions;
import couchbase.test.docgen.DocType.Hobby;
import couchbase.test.docgen.DocType.Location;
import couchbase.test.docgen.DocType.Person;
import couchbase.test.docgen.WorkLoadSettings;
import couchbase.test.dictionary.Dictionary;
